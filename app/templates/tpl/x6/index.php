...
<head>
    ...
    <style>
        ...
        <?php echo $less->compileFile($GLOBALS['ROOTPATH'] . '/common/template/header_pc_x6/index.less'); ?>
        <?php echo $less->compileFile('./index.less'); ?>
        <?php echo $less->compileFile($GLOBALS['ROOTPATH'] . '/common/template/footer_pc_x6/index.less'); ?>
    </style>
</head>
<body>
    ...
    <div class="ht960">
    <% } %>
        <?php include($GLOBALS['ROOTPATH'] . '/common/template/header_pc_x6/content.php'); ?>
    </div>
    ...
    <div class="ht960">
    <% } %>
        <?php include($GLOBALS['ROOTPATH'] . '/common/template/footer_pc_x6/content.php'); ?>
    </div>

    <?php include($GLOBALS['ROOTPATH'] . '/common/conf/require.php'); ?>
    <script>
        require([
            '/common/template/header_pc_x6/js/base.js'
        ], function() {
            require([
                '/common/template/header_pc_x6/index.js',
                '/common/template/footer_pc_x6/index.js'
            ], function() {
                require(['./index']);
            });
        });
